...
class DB:
    ...
    def upsert_assignment(self, course_id: int, a: dict) -> tuple[int, bool]:
        ...
        Returns (id, is_new). Never clobbers user notes."""
        existing = self.conn.execute(
