...
Getting the `~/campus` repo running from a fresh checkout. Consolidates the
`campus-repo-setup` skill body (2026-08-04 setup-friendliness audit); full
audit detail in [references/setup-friendliness.md](references/setup-friendliness.md),
verbatim original in [archive/](archive/).
