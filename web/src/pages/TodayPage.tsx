...
export function TodayPage({ onLogout }: { onLogout?: () => void }) {
	...
	const [events, eventsLoading] = useSWR<Event[]>(
		"events-next-7",
		api.eventsNext7,
		[],
	);
				...
				<div className="dash-grid">
					<div className="dash-col">
						<div className="card">
							...
							{digest ? (
								...
								<div className="empty compact">
									No digest yet — it generates after the next sync.
								</div>
							)}
						</div>
						...
						<div className="card">
							...
							{!eventsLoading && days.length === 0 && (
								<div className="empty compact">
									Nothing scheduled — the pilot term has ended.
								</div>
							)}
							{days.map(([day, evs]) => (
								<div
