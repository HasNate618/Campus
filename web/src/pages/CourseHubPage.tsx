		...
		<div className="row" style={{ alignItems: "flex-start" }}>
			<div className="row-main">
				...
				{a.body_html ? (
					...
					<div className="row-sub" style={{ whiteSpace: "pre-wrap" }}>
						{a.body}
					</div>
				) : null}
			</div>
...
export function CourseLayout() {
	...
	const [hideCourse, setHideCourse] = useState(
		() => localStorage.getItem("hc.split.hideCourse") === "1",
	);
			...
			<div className="card">
				...
				{hub.events.length === 0 && (
					<div className="empty compact">
						No upcoming events — the pilot term has ended.
					</div>
				)}
				{hub.events.map((e) => (
